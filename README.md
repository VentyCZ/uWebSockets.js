...
<a href="https://medium.com/@alexhultman/beware-of-tin-foil-hattery-f738b620468c">In response to slander</a>
</div>
<br><br>
...
We *recommend, for simplicity* installing with `yarn add uWebSockets.js@hotel-cz/uWebSockets.js#v20.10.0-C7` or any such [release](https://github.com/hotel-cz/uWebSockets.js/releases).
