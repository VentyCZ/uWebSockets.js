...
We *recommend, for simplicity* installing with `yarn add uWebSockets.js@hotel-cz/uWebSockets.js#v20.3.0-C7` or any such [release](https://github.com/hotel-cz/uWebSockets.js/releases).
